...
%
This section explains that from the broker's perspective, while individual targeting is more expensive (but safer), group targeting is cheaper (but more uncertain). Given this cost\/benefit structure, the paper contends that brokers will have incentives to engage in \emph{individual targeting} when targets are easier to identify, otherwise they will engage in \emph{group targeting}. \autoref{tab:strategy:set} presents four ideal types in four quadrants; cases where individuals are highly identifiable, that is, non-poor individuals living in poor areas (Q1), and poor individuals living in non-poor areas (Q4). Identifiability in these cases reduces the cost of defection, permitting clientelist brokers to closely follow their clientele. The table also shows cases where individuals are hard to identify, that is, poor individuals living in poor areas (Q2), and non-poor individuals living in non-poor areas (Q3). In these cases, voters are more anonymous, making direct individual-based targeting and monitoring more costly. Since brokers still have incentives to seek electoral support, they rely on the spillover effects of clientelism. In these cases, the effects of vote-buying disseminates by mobilizing targeted voters, but also a latent untargeted (but potential) clientele.
...
\paragraph{Group targeting} is the less accurate targeting strategy, but also the cheapest one available to brokers. This tactic leverages the spillover effects provided by larger concentrations of individuals by mobilizing electoral support from actual clients (individuals who have actually been targeted), \emph{and} potential clients (individuals who have not received benefits yet). It is preferred when poor individuals are nested in poor areas (Q2), or vice-versa (Q3). Since in these cases individuals are masked by their environments, identifiability is hard to achieve. Identifiability facilitates individual targeting, an important factor in reducing the probability of defection of targeted clients. When individuals are hard to identify, however, individual targeting becomes prohibitively expensive. Yet, brokers still needing to secure electoral support, do not opt out of clientelism, but turn to group targeting.

% example of spillover using Auyero's theory
\citet[65]{Auyero2000} describes the case of \emph{Alfonsina} in Argentina. \emph{Alfonsina} was part of the brokers' inner circle and got a job as a cleaning lady in a public school. As the broker explained to her before getting the job, \emph{Alfonsina} had to be \emph{patient} because as a member of ``the circle,'' she was in the pool of potential beneficiaries; it was only a ``matter of time'' until she could get the job. The idea of expectations and hope are important. He explains that the ``\emph{hope} of a job serves as important glue within the inner circle. Although not everyone is employed at the municipality, the fact that someone gets [a] job has an important \emph{demonstration} effect.''\footnote{Emphases are mine.} Building on this intuition, two ideal types are suggested: \emph{actual} and \emph{potential} beneficiaries. The former receive particularistic benefits ``today'' and vote for the broker's candidate ``tomorrow,'' while the latter do not receive benefits ``today'' (in the expectation of receiving them in the future) but \emph{still} vote for the broker's candidate.


% it explains the spillover component
Group targeting is cost-effective because it mobilizes two types of voters at the cost of investing in only one type. Actual beneficiaries, since they want to keep receiving benefits, want to remain actual beneficiaries; thus, they keep supporting the broker's candidate. In turn, potential beneficiaries want to become actual beneficiaries, but are uncertain when that might happen; as a result, they also support the broker's candidate. In this sense, from the broker's perspective, this strategy reduces the sunk costs by one half, multiplying the gross benefits by two. In other words, the broker's reputation of a ``problem solver'' disseminates twice as fast relative to individual targeting. Reputation, as a capital, is fundamental for brokers since ``voters prefer to support [brokers] with a reputation for delivering because they are a more reliable source of future rewards.''\footnote{\citet[24]{Zarazaga2014}.}

% HERE

While cost-effective, it is less accurate, however. Brokers hope to mobilize potential beneficiaries only indirectly, that is, by targeting actual beneficiaries. 

Hence it makes it a fragile strategy relative to individual targeting. 


In fact, brokers need to infer the discount factors of their potential clients, making it expensive for potential targets to defect.

%This mechanism requires the broker's ability to not allow the transaction costs of switching strategies to be lower than what it costs clients to wait to be benefited. In other words, brokers need to take care of their reputation and, eventually, deliver the benefits, an insight that goes in line with \citet[14]{Zarazaga2014}, who explains that brokers and voters' interests are aligned. 


In turn, from the target's perspective, there are several costs that set the equilibrium in voting for the broker's candidate.

Potential clients know that the flow of resources is dependent on the brokers' electoral success.  




Also, potential clients do not know whether new brokers might have access to fewer resources, or distribute them to other people. 


Finally, the cost of switching brokers (or defecting) is very high since it also involves building from scratch relationships of confidence with another broker. 



Hence the incentives are set in supporting the broker. 


No matter what type an individual is, both actual and potential beneficiaries keep voting for the broker's candidate. 



While fragile, this strategy is sustained on a very clear set of incentives. 

Brokers anticipating that, engage in group targeting since it is worth the risk, especially in cases of high political contestation, and where targets are poor individuals living in poor areas (Q2). 



Given that the poor are risk-averse, potential beneficiaries are better-off waiting (and voting for the broker's party) than defecting.\footnote{In the same vein but in a slightly different subject, \citet[20]{Magaloni:2008bq} explains that The Mexican PRI lasted as long as it did not because of electoral fraud but because voters supported the ``known devil.''} 
