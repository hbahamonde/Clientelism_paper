...
%\afterpage{
%\clearpage
<<municipality:income:large:plot:matched:plot, echo = FALSE, fig.pos='H', warning = FALSE, message = F, fig.cap=municipality.income.large.plot.matched.plot.legend, fig.align='center', fig.width=7, fig.height=8,dpi=20000,cache = FALSE>>=
...
<<plot:four:quadrants, echo = FALSE, fig.pos='h', warning = FALSE, message = F, fig.cap=plot.four.quadrants.plot.legend, fig.align='center', fig.width=5, fig.height=3.5,dpi=300,cache = FALSE>>=
...
<<municipality:sample:plot, echo = FALSE, fig.pos='H', warning = FALSE, message = F, fig.cap='Frequency of Individuals by Municipality, Pre---and Post---Matching Deletion.', fig.align='center', fig.width=7, fig.height=8,dpi=10000,cache = FALSE>>=
