...
% DOCUMENT ID
\fancyhead[C]{Revise and Resubmit (JPLA)} % Custom header text
...
% Motivation 1: Income
Perhaps the area in which there is the most agreement among scholars is on the relationship between poverty and vote-buying.\footnote{See \citet[]{Calvo2004,Weitz-shapiro}, \citet{Kitschelt2000} and \citet[]{Kitschelt2015}. Following \citet[316]{Nichter2014}, clientelist vote-buying is defined as ``the distribution of rewards to individuals or small groups during elections in contingent exchange for vote choices.'' This definition is broad enough to encompass the ``group'' and the ``individual'' targeting strategies developed on this paper.} For example, \citet{Brusco2004}, \citet[]{Stokes:2013cj}, and \citet[]{Nazareno2008a} explain that since the poor derive more utility from immediate transfers than the uncertain returns associated with future policy packages, clientelist political parties \emph{only} target the poor. In fact, \citet[12]{Weitz-Shapiro:2014aa} explains that ``[a]lmost \emph{universally}, scholars of clientelism treat and analyze [this] practice as an exchange between politicians and their poor clients.''\footnote{Emphasis is mine.} 
...
Another often-considered contextual factor in the literature is the size of the community where clientelism takes place. Large-sized communities impose severe principal-agent problems. \citet[323]{Stokes2005} explains that the ``community structure'' mediates the incentives to defect. Large communities make voters more anonymous, increasing their probability of defection. In fact, \citet[164]{Rueda2016} finds that in Colombia, vote buying is more effective in contexts of \emph{small} polling places. Several scholars have then argued that brokers prefer smaller groups because individuals nested in small communities should defect less.\footnote{\citet[]{Brusco2004}, \citet[10]{Kitschelt2007} and \citet[67]{Magaloni:2008bq}. Similarly, see \citet[]{Bratton2008a} for Nigeria and \citet[456]{Gingerich2013} for Brazil.} Yet, even when brokers might prefer to target small communities (with lesser voters relative to large communities), it is not clear how political parties gain enough electoral returns, especially considering that clientelism is expensive. 

Vote-buying is an expensive strategy,\footnote{\citet[35]{Zarazaga2014}.} and more so when clients are individually targeted.\footnote{\citet[1147]{Dixit1996} explain that brokers track ``constituents' likes and dislikes, \emph{compulsively} participating in a spectrum of events [such as] baptisms and bar mitzvahs, weddings and funerals [and even, holding] \emph{daily} meetings with constituencies [even] \emph{after} nine o'clock [hearing] what anyone wished to tell [them].'' Emphases are mine.} \citet[317]{Stokes2005} argues that brokers develop skills that allow them to infer whether individual clients in small-sized communities voted for their party by \emph{looking at them in the eyes.} \citet{Gay:1993aa,Gay1998} documents similar findings for Brazilian case. This strategy requires brokers to sustain close relationships over time with their clients in a personal and individualized way. Knowing the client's needs, delivering him benefits, monitoring his political behavior (and punishing him in case of defection), all in an individualized fashion, makes this strategy an extremely expensive choice. And it gets even more expensive as more individuals are added to the broker's portfolio.


The cost of individual targeting increases linearly with the size of the targeted population.\footnote{\citet[56]{Hicken2007}.} This intuition is important because the brokers' production-possibility frontier cannot be shifted upwards either. Since the number of brokers is a depletable resource, at some point party machines run out of enough brokers, implying that monitoring capacities are bounded. In fact, \citet[74]{Auyero2000} explains the capacity brokers have to deliver benefits is ``finite,'' and ``only for a restricted number of people.'' However, and despite this constraint, brokers still have incentives to secure a large amount of votes. Yet, the literature explains that clientelism should decrease in large communities. However, it is hard to conceive that brokers will stop being clientelist just because the size of the population is large. A priori, it seems a missed opportunity for brokers to let go a large amount of votes. In fact, survey data for the Brazilian case indicate that inhabitants of large, medium, and small municipalities are targeted in virtually the same proportion.\footnote{\citet[2]{Speck2001}.} This article explains that when brokers need to secure large amounts of electoral support, especially when political competition is high, they turn to group-targeting strategies, relying on the spillover effects of clientelism. In these contexts, clientelism mobilizes electoral support from \emph{actual} and \emph{potential} beneficiaries, minimizing the costs of clientelist targeting while maximizing electoral benefits, a mechanism that I explain later on in the paper.
...
While buying votes from non-poor individuals costs more, brokers in non-poor areas have more resources to spend. In the same line, \citet[55]{Hicken2007} questions the implicit assumption that the broker's vote buying funds remain fixed. In fact, he explains that ``a candidate's capacity to buy votes increases commensurate with increases in average incomes.'' In other words, higher levels of economic development not only raises personal incomes, but also shifts upwards the broker's vote-buying capacities. Similar evidence has been found in Philippines.\footnote{\citet{Schaffer:2004aa}.} The link between higher incomes and vote buying is particularly relevant for Brazil, since its electoral laws allows political parties to get unlimited funds,\footnote{\citet[14]{Abramo2001}.} allowing brokers higher capacities to buy more expensive votes. 
