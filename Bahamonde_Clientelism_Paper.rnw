...
\hspace{2cm}\begin{tabular}{ r|c|c| }
\multicolumn{1}{r}{}
& \multicolumn{1}{c}{Poor Individuals} & \multicolumn{1}{c}{Non-Poor Individuals} \\
\cline{2-3}
Low Competition  & \pbox{15cm}{\relax\ifvmode\centering\fi {\bf Low Density} \\ \emph{Easily identifiable}} & \pbox{15cm}{\relax\ifvmode\centering\fi{ \bf Low Density} \\ \emph{Expensive/Low clientelism}\\ \emph{Corruption}}\\
\cline{2-3}
High Competition & \pbox{15cm}{\relax\ifvmode\centering\fi{\bf High Density} \\ \emph{Spillover effects}} & \pbox{20cm}{\relax\ifvmode\centering\fi {\bf High Density}\\ \emph{Easily identifiable}} \\
\cline{2-3}
\end{tabular}
\end{table}
...
In an important paper, \citet[]{Weitz-shapiro} argues that higher levels of political competition in the presence of low socioeconomic levels at the municipal level are positively associated to clientelism in some Argentine municipalities. In the absence of these two, politicians opt-out of clientelism to avoid audience costs. This paper adopts the same empirical strategy and measures poverty (and political competition) at the municipal level. However, it makes the idea of ``costs'' more explicit. In \citet[]{Weitz-shapiro}'s argument, losses are conceptualized in terms of ``moral costs''\footnote{\citet[]{Weitz-shapiro} argues that politicians opt-out of clientelism since non-poor individuals are more likely to condemn clientelism ``due to self-interest or because of \emph{moral} concern[s]''. Self-interest refers to the idea that what is distributed through clientelism is discounted from the pool of resources theoretically available to be spent on policy packages.}. In a similar vein, \citet{Carlin2015} citizens endowed with more democratic values feel more``moral repugnance'' for clientelism. \citet{Vicente2014} argues that vote-buying practices have an ``immoral/illegal connotation'', while \citet{Gonzalez-Ocantos2012} find individuals usually do not elicit truthful answers when directly asked about clientelism. The idea of the ``psychic costs'' attached to clientelism can be problematized, however. \citet{GonzalezOcantos2014} find that while the concrete benefits obtained through clientelism are in generally well understood, ``the abstract societal costs of such exchanges are often distant from the every-day world in which clientelistic relationships are formed''. More educated individuals condemn more, individuals with more exposure  to it along with the poor condemn less. 
...
# SHapiro
  ## ``High competition should be compatible with clientelism when poverty is high, but should decrease the incentives for clientelism where poverty is low''.
  ##``although clientelism is a vote-getting tactic aimed at the poor, non-poor voters are likely to punish politicians who engage in it. The salience of these costs should vary with the share of the population that is non-poor and a politician’s security in office''.
  ## ``Statistical analysis supports the claim that neither poverty nor political competition alone explains why some politicians opt out of clientelism. Only when a large opposition presence is coupled with a sizable middle class does the use of clientelism decline''
...
% concluding paragraph, summarizing the challenges of SIZE, COMPETITION and NETWORKS
We are left with many questions. First, there is no consensus on how individual and macro-structural characteristics interplay to produce clientelism. More than being an issue about a choice of the unit of analyses, there are very different consequences and explanations for why parties might want to engage in one or the other. 
...
% purpose of this paper: 
		...
		``Existing research looks almost exclusively at individuals’ socio- economic and, especially, electoral profile'' (Carlin2015).
		``Yet our knowledge of who parties target remains incomplete''  (Carlin2015).
...
% OK Introduction
% OK Hook//Question.
% OK Summary of the paper
% OK Methodology
% ?? The size of the poor, competition AND personal income matter
% Purpose of this paper.
% Why it matters.
...
%% ARGUMENT: MODIFY - USE WHAT I GOT IN THE NOTEBOOK
Since heavy contestation demands higher levels of electoral mobilization, motivated brokers will have the incentives to engage in group-targeting. Under these circumstances, group-targeting though a risky choice, becomes a cheaper alternative. Given that brokers cannot increase their targeting capacities when it comes to target large groups, brokers take their risks and rely on the spillover effects that large aggregations of poor individuals provide. However, when political competition is low, brokers have a different incentive structure and rather target individuals that live nested in low-density poverty contexts. These environments make targeted poor individuals more unique, observable and identifiable, making them easier to target and monitor. Non-poor individuals  also get targeted. Though these are more expensive clients, low political competition also implies a situation of quasi political monopoly and lower levels of checks and balances. Such combination helps brokers buy at rather higher relative costs votes of identifiable non-poor individuals. 
...
% Concluding paragraph on poor-density targeting USE THIS ONE
...
# My argument
	## 
		...
		### The paper argues that brokers have an incentive structure that changes depending on patterns of competition and the size of the poor group. Hence, poverty structure, whether the individuals are nested in contexts of high or low ``poverty density'' and the political constrains incumbents face at every election, are not a substitute for individual characteristics or macro-structural conditions, but rather they complement them.
		### Vicente2014 argues ``vote buying increases participation and counteracts the incumbency advantage''. I find that vote buying is higher where political is competition low BUT the density of the poor is low too. In this sense, vote buying helps to sustain incumbency advantage, not counteracts it.
		### Szwarcberg2013 ``challenges the assumption that parties and candidates with access to material benefits will always distribute goods to low-income voters in exchange for electoral support''.
	## Against Rueda:  
...
# Section on Brazilian politics.
 ...
 # My argument
 	...
 	## ``Unquestionably, brokers are deeply nested in social networks'' (Carlin2015:15)
