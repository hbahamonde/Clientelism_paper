...
% the literature doesn't agree
There is not agreement on whether parties target individuals \emph{or} groups. On the one hand, the distributive politics and vote-buying literatures offer different answers for this very important question. The distributive politics literature mostly focuses on groups, usually districts (see for example \citet[]{Dixit1996} and most recently, \citet[]{Khemani2015}) or provinces (\citet[]{Calvo2004}). In this literature brokers deliver public-sector jobs or construction projects contingent on the support of \emph{groups} of individuals. On the other hand, the vote-buying literature has typically focused on individuals and their characteristics such as socio-economic and electoral profiles (\citet[]{Carlin2015}). Particularly, individual poverty has been positioned as one of the main explanations of clientelism (\citet{Kitschelt2000,Calvo2004} and Kitschelt and Altamirano in \citet[ch. 10]{Carlin:2015}). Very recently, some papers have stressed the impact of macro-conditions. For example \citet[]{Weitz-shapiro} studies how high-political competition (a macro-structural factor) interacted with individual income is positively associated to more clientelism. 
...
# SHapiro
  ...
  ## Psychic Costs: ``The non-poor might object to clientelism either due to self-interest or because of moral concern
about the practice''
