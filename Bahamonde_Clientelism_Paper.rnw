...
There is no agreement on when parties should target individuals and when parties should target groups. The distributive politics and vote-buying literatures have traditionally followed two different practices. Both practices have been more product of the choice of the research design (unit of analysis or methodology employed) rather than an explicit theoretical decision. On the one hand, the distributive politics literature has mostly focuses on groups, usually districts or provinces (\citet[]{Dixit1996}, \citet[]{Khemani2015}, \citet[]{Calvo2004}). In this literature, incumbent parties deliver public-sector jobs or construction projects contingent on the support of \emph{groups} of individuals. On the other hand, the vote-buying literature has typically focused on individuals and their characteristics such as socio-economic or electoral profiles (\citet[]{Carlin2015}). 

% OK income: hook 2
Yet the most consolidated agreement is on the positive effects of individual poverty on clientelism (\citet[]{Calvo2004,Weitz-shapiro}). \cite{Kitschelt2000}\footnote{See also Kitschelt and Altamirano in \citet[ch. 10]{Carlin:2015}.}, \citet{Brusco2004} and \citet[]{Stokes:2013cj} explain that political parties target the poor \emph{only}. \citet[]{Nazareno2008a} explain that the poor derive more utility from immediate transfers than future and risky returns associated to policy packages. This canonical predictor has been recently challenged, however. \citet{GonzalezOcantos:2012vr} and \citet[]{Holland2015} explain that income (measured at the individual level) has little or no effect on clientelism. Why do newer papers with newer methodological techniques report null fundings on poverty, the \emph{most} important predictor of clientelism? 

% OK questions
The lack of clarity on whether parties should target groups or/and individuals and when (if) they should switch strategies leave us in a confusion. For example, the literature is not explicit on whether ``the poor'' constitute poor \emph{groups} or poor \emph{individuals}. There has not been an explicit effort to theorize about the differences these two types of targeting strategies imply for both parties and individuals (either considered on their own or nested in groups). For example, \citet[10]{Kitschelt2007} argue that political parties target ``individuals \emph{or} identifiable small groups''\footnote{Emphasis added.}. However, it is not clear what makes parties to focus on one or the other, or both at the same time, why and how. This paper tries to shed light on those issues.

% OK Summary of the paper: LIT REVIEW // ARGUMENT // METHODS
This paper proceeds as follows. First, it reviews classic and newer research on vote buying, particularly paying attention to the tension that exists in the literature. As the paper argues, this tension is due to the lack of clarity on whether parties target individuals and/or groups and when. Second, it presents the argument. Expanding on some recent research that stresses the role of political competition and the size of the poor group, this paper introduces a third dimension, individual income. The mechanic of the argument is novel as it makes the case that parties switch strategies depending on these three dimensions. The paper argues that when political competition is high, brokers engage in group targeting by targeting individuals that live nested within high-dense poverty clusters, \emph{regardless of their individual levels of income}. Since heavy contestation demands higher levels of electoral mobilization, motivated brokers will have the incentives to engage in group-monitoring. Under these circumstances, group-monitoring though a risky choice, becomes a cheaper alternative. Given that brokers cannot increase their monitoring capacities when it comes to target large groups, brokers take their risks and rely on the spillover effects that large aggregations of poor individuals provide. However, when political competition is low, brokers have a different incentive structure and rather target individuals that live nested in low-density poverty contexts. These environments make targeted poor individuals more unique, observable and identifiable, making them easier to target and monitor. Non-poor individuals  also get targeted. Though these are more expensive clients, low political competition also implies a situation of quasi political monopoly and lower levels of checks and balances. Such combination helps brokers buy at rather higher relative costs votes of identifiable non-poor individuals. Third, the paper presents the methodology. Exploiting within-municipality variations of individual income in both low and high density contexts in Brazil, and a matched design, the empirical section tests and presents supporting evidence for the theory. Fourth, the paper offers some final considerations.


\section*{When do parties target individuals and when groups?} 

% OK new papers // PRESENT MAIN THEORIES // (0)
In both the classic and the newer literatures coexist theories, methodologies, measurement and identification strategies that either focus on only individual \emph{or} group targeting, as if they were interchangeable. In fact, most of the time, the distinction is rather product of the method or epistemological tradition. For example, most ethnographers have considered individual targeting (see for example \citet{Auyero2000}). Papers employing experimental methods tend to vary, but most accounts are centered in aggregations of individuals (see for example \citet{Weitz-shapiro} and \citet{Gonzalez-Ocantos2012}). Rather than describing a detailed list of works and their methodologies, the important point is that what has driven the decision to study group-based and individual-based targeting strategies (by separate or jointly, as this paper does) has been based on considerations of research design. Unfortunately, most of the times it has been \emph{implied} that there is no difference between these strategies. As this paper suggests, the structure of incentives each of them provides is something that the literature should consider.

% OK new papers // PRESENT MAIN THEORIES // size (1)
One of the first contextual factors has been the size of the community. Group-size has always been an important consideration in social science. Classic political economy literature has longly argued how large groups face more coordination dilemmas (see for example \citet[]{Aldrich}). The main intuition is that if a individual's vote is bought, she may be tempted to accept the benefit and then vote for her preferred candidate. Given that the size of the community is large, she hopes others will vote for the candidate so he continues delivering benefits. Taking this idea as a starting point, several scholars have argued that smaller groups are preferred for brokers because they defect less. For example, \citet[323]{Stokes2005} and \citet[10]{Kitschelt2007} suggest that the size of population is negatively associated to clientelism. Smaller communities have higher likelihoods of receiving clientelistic goods since they are easier to monitor. This mechanism, with some modifications, has been readdressed very recently. For the Colombian case, \citet{Rueda2016} argues that clientelism will be higher when the electoral results of small groups are available. In reverse, generally these type of arguments consider that large communities posit important incentives to individual to defect. In Nigeria, \citet[]{Bratton2008a} finds that the strongest predictor of defection is the expectation of others defecting. In Brazil \citet[p. 456]{Gingerich2013} find that ``vote brokerage thrives in municipalities with very small electorates''. 


% OK new papers // PRESENT MAIN THEORIES // size and networks (2)
Given the challenges large-sized groups present, the literature has explained how brokers solve these difficulties. In low-information environments, (most) brokers cannot observe individual electoral behavior. Given this impossibility, brokers resort to substitutes that are efficiency-decreasing as the size of the targeted group increases. These substitutes are formal and informal \emph{networks}. \citet{Schaffer2015} explains that clientelism is ``socially multiplied'', as party machines target individuals ``who are opinion-leading epicenters'' in informal situations. If parties buy turnout (\citet[]{Nichter2008}), they will most probably target associations too, as ``citizens immersed in clientelistic networks [...] have a higher probability of voting than the rest'' (\citet[p. 7]{Carreras2013}). In a similar vein, \citet{Calvo2012} argue that parties target formal ``partisan networks'', in what has been called ``organization buying'' (\citet[p. 250-251]{Stokes:2013cj}). For example, \citet[p. 16]{Holland2015} explains that when ``parties lack their own brokerage networks [they seek] to capitalize on organizational networks instead''. As \citet[]{Rueda2014a} explains, parties tend to target very specific civic associations\footnote{Particularly, associations of ``seniors and associations of single mothers, organizing trips to recreational centers outside the city where all their expenses are covered'' (p. 13).}. Paradoxically, the stronger the civic society, i.e. the more organized it is, the more clientelism. The issue of poverty has also been reconsidered. 




% new papers // size // networks: CRITICIZE THESE VIEWS
We are left with many questions. First, there is no consensus on how individual and macro-structural characteristics interplay to produce clientelism. More than being an issue about a choice of the unit of analyses, there are very different consequences and explanations for why parties might want to engage in one or the other. Second, though ``organization buying'' seems really intuitive and appealing, it is not clear whether parties target networks (whether formal or/and informal) because of poverty or for any other reason. 

etwork effects seem really intuitive and appealing. However, what has not been explored yet is whether clientelism is explained by the ``cluster'' or the ``network'' components attached to association membership. Membership into local grass-root associations typically also involve a situation of high-dense poverty. Keeping coordination costs constant, groups typically are formed to address collective problems that otherwise would be much costly to solve by individuals on their own. If this were the case, formal group membership should be spuriously related to clientelism.  In other words, is clientelism associated to group membership itself, or is it associated to the density of the poor that is also present in associations? The models here presented suggest that once the effects of associationism are separated by different poverty density levels, it becomes very clear that what explains clientelism is the density of the poor, not membership association.
