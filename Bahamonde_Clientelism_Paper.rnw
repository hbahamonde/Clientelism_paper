...
This section explains that from the broker's perspective, individual targeting is more expensive (but safer), while group targeting cheaper, but more uncertain. The paper contends that brokers will have incentives to engage in \emph{individual targeting} when targets are easier to identify, and in \emph{group targeting} when targets are hard to identify. \autoref{tab:strategy:set} presents four ideal types in four quadrants; cases where individuals are highly identifiable, that is, non-poor individuals living in poor areas (Q1), and poor individuals living in non-poor areas (Q4). Identifiability in these cases reduces the cost of defection, permitting clientelist brokers closely follow their clientele. The table also shows cases where individuals are hard to identify, that is, poor individuals living in poor areas (Q2), and non-poor individuals living in non-poor areas (Q3). In these cases, direct individual-based targeting is costly, and hence brokers rely on the spillover effects of clientelism. In these cases, the effects of vote-buying disseminates by mobilizing a latent targeted clientele.
...
The capacity brokers have to identify potential clients does not necessarily come from third-party sources (associations), as the ``organization buying'' proponents explain,\footnote{\citet[]{Holland2015}, \citet[]{Rueda2014a} and\citet{Stokes:2013cj}.} but from a few observables brokers have at their disposition. In this paper I focus on how \emph{noticeable} individuals are in their respective contexts. Should brokers engage in individual targeting, they would rather visit highly noticeable \emph{poor} households in largely \emph{non}-poor neighborhoods. As these households stand out in these contexts, it is easy for brokers to notice whether they need construction materials, whether there are wakes to which they could contribute flowers or birthday parties to which they could bring cakes. Borrowing \citet[26]{Zarazaga2014}'s language, higher levels of visibility, in summary, supply brokers with \emph{good-quality information about their clients}'. 

And even when brokers are also ``neighbors,''\footnote{\citet[38]{Zarazaga2014}.} that is, members of the same community of the targeted individuals, brokers have incentives to expand their immediate local networks by colonizing visible targets outside of their own proximate neighborhood. By conceptualizing brokers as active political entrepreneurs who seek new supporters outside of their immediate context, the proposed framework complements other accounts, as presented in \citet[32]{Szwarcberg2013} or \citet[681]{Zarazaga2015a}, where brokers are neighborhood party agents. Clientelist entrepreneurship can be done directly, or indirectly. For instance, \citet[65-66]{Auyero2000} describes the situation of \emph{Cholo}, a member of the inner circle of one of the brokers in Buenos Aires, Argentina, who visited ``other poor neighborhoods of the area adjacent to'' the place where the broker (and himself) lived, to spread news about some government plan, the governor and the Peronist party, but importantly, also \emph{reporting to the broker any unattended material needs he had noticed}. Via different channels, brokers expand their client portfolio outside of their immediate community. 


Importantly, in this framework, individual poverty does not play a role by itself. What is more relevant is how individual incomes \emph{interact} with their respective socio-economic contexts, making individuals more or less noticeable. Individuals are more noticeable when non-poor individuals are nested in poor areas (quadrant 1) or when poor individuals are nested in non-poor areas (quadrant 4), as shown in \autoref{tab:strategy:set}.\footnote{Importantly, poor households need not be close to each other, but \emph{visible} enough for brokers to detect their needs.} Another necessary condition studied in this paper are the levels of political competition. In quadrant 1, 




%Importantly, contexts of higher electoral contestation need wider margins of electoral support. While the bulk of it comes from quadrant 2 (which I explain next), under contexts of high electoral competition, votes from non-poor individuals are also bought.
...
\todo{expand here}Vote-buying is also targeted to non-poor groups individuals nested in poor groups (quadrant 3)\todo{On theoretical grounds, one might question the assumption implicit in arguments about the decreasing marginal utility of vote buying-namely that a candidate's vote buying funds remain fixed or at least rise more slowly than average incomes. Alternatively, one might assume that a candidate's capacity to buy votes increases commensurate with increases in average incomes. Development, in other words, means more resources for both voters and candidates. If this is the case, then development may have no effect on the prevalence of vote buying. Ultimately Hicken2007, p. 55, especially since quote: There are no limitations to party funding, this in Abramo2001 p 14}. On the one hand, vote-buying has decreasing returns to scale in non-poor individuals. That is, wealthier individuals derive less advantages from a bag of rice relative to poorer individuals.\footnote{\citet{Kitschelt2000}.} Candidates, anticipating this, will not offer the same benefits to wealthy individuals, segmenting the type of offerings they make to the better-off. To be attractive, these goodies should be relatively more expensive. Consequently, buying votes from non-poor individuals gets more expensive as income increases. Low levels of political contestation give local politicians more ``room to move,'' allowing them to divert local resources into more expensive means of targeting (embezzlement). 
