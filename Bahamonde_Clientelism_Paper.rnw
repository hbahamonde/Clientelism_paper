...
While buying votes from non-poor individuals costs more, brokers in non-poor areas have more resources to spend. In the same line, \textcite[55]{Hicken2007} questions the implicit assumption that the broker's vote buying funds remain fixed. In fact, he explains that ``a candidate's capacity to buy votes increases commensurate with increases in average incomes.'' In other words, higher levels of economic development not only raises personal incomes, but also shifts upwards the broker's vote-buying capacities. Similar evidence has been found in Philippines.\footnote{\textcite{Schaffer:2004aa}.} The link between higher incomes and vote buying is particularly relevant for Brazil, since its electoral laws allows political parties to get unlimited funds,\footnote{\textcite[14]{Abramo2001}.} allowing brokers higher capacities to buy more expensive votes. 
