...
% OK questions
The lack of clarity on whether parties should target groups or/and individuals and when (if) they should switch strategies, leave us in big confusion. For example, the literature is not explicit on whether ``the poor'' constitute poor \emph{groups} or poor \emph{individuals}. There has not been an explicit effort to theorize about the different set of incentives these two targeting strategies present to both parties and individuals (either considered on their own or nested in groups). For example, \citet[10]{Kitschelt2007} argue that political parties target ``individuals \emph{or} identifiable small groups''\footnote{Emphasis added.}. However, it is not clear what makes parties to focus on one or the other, or both at the same time, why and how. This paper tries to shed light on those issues.

% OK Summary of the paper: LIT REVIEW // ARGUMENT // METHODS
This paper proceeds as follows. First, it reviews classic and newer research on vote buying, particularly paying attention to the tension in the literature regarding the lack of clarity on whether parties target individuals and/or groups and when. Second, it presents the argument. Expanding on some recent research, we also stresses the role of political competition. In addition to that, the argument and the empirics also decompose the different effects on clientelism of ``being poor'' and ``living in a poor area''. Altogether, four ideal types are presented, poor individuals nested in (1) poor and (2) non-poor clusters, and non-poor individuals nested in (3) poor and (4) non-poor contexts. The mechanic of the argument is novel as it makes the case that parties switch strategies depending on these three dimensions simultaneously. The argument departs from the canonical (and until recently) (un)challenged finding that only ``the'' poor receive clientelism. Each of these ideal types presents a series of incentives for both brokers and individuals that make them engage in clientelism, either delivering it or accepting it. This paper argues that brokers engage in individual targeting when individuals are highly identifiable, that is, when poor individuals live in rather non-poor areas and when non-poor individuals live in poor areas. Simultaneously, when incumbent politicians are electorally challenged (and in need of more electoral support), brokers target areas where the density of the poor is large \emph{regardless of individual incomes}. In these contexts, the poor are targeted since brokers take advantage of the spillover effects large concentrations of poor individuals provide. Non-poor are also targeted, since in these contexts they are more noticeable, and can be kept more accountable. Third, the paper presents the methodology. Exploiting within-municipality variations of individual income in both low and high density contexts in Brazil, and a matched design, the empirical section tests and presents supporting evidence for each of the ideal types. Fourth, the paper offers some final considerations.

\section*{When do parties target individuals and when groups?} 

% OK new papers // PRESENT MAIN THEORIES // (-0)
In both the classic and the newer literatures coexist theories, methodologies, measurement and identification strategies that either focus on only individual \emph{or} group targeting, assuming that both strategies are interchangeable. In fact, most of the times, the distinction is rather product of the method or epistemological tradition. For example, most ethnographers have considered individual targeting (see for example \citet{Auyero2000}). While papers employing experimental methods tend to vary, but most accounts focus on individuals aggregated at some level (see for example \citet{Weitz-shapiro} and \citet{Gonzalez-Ocantos2012}). Rather than describing a detailed list of works and their methodologies, the important point is that what has driven the decision to study group-based and/or individual-based targeting strategies (by separate or jointly, as this paper does) has been mostly driven by considerations of research design. Unfortunately, there is no clear theory for why, how and when parties would engage in one or the other. In addition to that, this interchangeability also \emph{implies} that there is no difference between these strategies. As this paper suggests, the structure of incentives each of them provides is something that the literature should address.
...
The positive relationship between group-membership and clientelism seems intuitive and appealing. However, what has not been explored yet is whether clientelism is explained by the ``cluster'' or the ``organization buying''  components attached group-membership. Membership into local grass-root associations typically also involve a situation of high-dense poverty. That is, a situation where 

% HERE

Keeping coordination costs constant, groups typically are formed to address collective problems that otherwise would be much costly to solve by individuals on their own. If this were the case, formal group membership should be spuriously related to clientelism.  In other words, is clientelism associated to group membership itself, or is it associated to the density of the poor that is also present in associations? The models here presented suggest that once the effects of associationism are separated by different poverty density levels, it becomes very clear that what explains clientelism is the density of the poor, not membership association.

Is it that parties target associations (i.e. groups) because they are organized or because they are composed by poor individuals? 


% PRESENT HERE THE political competition ISSUE
\citet[]{Weitz-shapiro} studies how high political competition levels in the presence of low socioeconomic levels are positively associated to clientelism in some Argentine municipalities. In her argument, the middle class condemns clientelistic practices , ``due to self-interest or because of \emph{moral} concern[s]''\footnote{Emphasis is mine.}. Clientelistic politicians anticipating those costs, opt-out of clientelism. 
